        ...
        <script>
            $(function () {
                ...
                $('#container').highcharts('Map', {
                        ...
                        series: {
                            ...
                            /* point: {
                                events: {
                                    click: function () {
                                        WEB-INF\views
                                        location.href = '${pageContext.request.contextPath}/pendudukaceh';// + this.options.lukkey;
                                    }
                                }
                            } */
                            point: {
                                events: {
                                    click: function () {
                                        location.href = 'resources/pendudukaceh.jsp';// + this.options.lukkey;
                                    }
                                }
                            }
                        }
                    ...
                    title: {
                        text: 'Jumlah Penduduk Indonesia Tahun 20xxyy'
                    },
                    subtitle: {
                        text: '(Sumber : BPS)'
                    },
